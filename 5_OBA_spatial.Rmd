...
```{r}
getwd()
setwd("/home/piyush/Dropbox/Academics/BI510L Data Sci in R/BI510L Data Sci in R_code/5_OBA_spatial")
...
plot_or_w_county +
  ...
  geom_polygon(data = or_map_with_population_df, aes(x = longitude, y = latitude, fill = population, group = county_name), color = "white") +
...
ggplot() +
  ...
  labs(color = "", caption = "\n\nTrend: Counties with higher population have a higher incidence of finding this bee\n
       This can be either because the counties with higher population have a sampling bias or \n
